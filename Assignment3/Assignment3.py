...
# Acknowledgements:
# I worked with class
# I used the following sites: https://www.geeksforgeeks.org/, https://numpy.org/doc/, https://stackoverflow.com/
...
def divcong_mult(m1, m2):
    m3 = divcong(np.array(m1), np.array(m2))
    return m3
...
def run_algs(algs: object, sizes: object, trials: object) -> object:
    dict_algs = {}
    for alg in algs:
...
def main():
    ...
    assn = "Assignment3"
    sizes = [4, 8, 16, 32, 64]
    algs = [numpy_mult, listcomp_mult, simple_mult, divcong_mult, strassen_mult]
    trials = 1

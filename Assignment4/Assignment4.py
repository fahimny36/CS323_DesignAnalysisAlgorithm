...
def read_file(file_name: object) -> object:
...
def mini_test():
    verbose = False
    text = read_file("input_dlr/Assignment4_Text1.txt")
    print("Text: ", text)
    patterns = read_file("input_dlr/Assignment4_Patterns.txt").split("\n")
...
def main():
    ...
    for pattern_length in [4, 8, 12, 16]:
        ...
        Assignment2.plot_times(dict_algs, sizes, algs, title,  assn + ".png")
